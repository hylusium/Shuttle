...
public class ArtworkDialog {
    ...
    public static MaterialDialog build(Context context, ArtworkProvider artworkProvider) {
        ...
        UserSelectedArtwork userSelectedArtwork = ((ShuttleApplication) context.getApplicationContext()).getUserSelectedArtwork(artworkProvider.getArtworkKey());
        ...
        return new MaterialDialog.Builder(context)
                ...
                .onPositive((dialog, which) -> {
                    ...
                    if (checkedView != null) {
                        ...
                        ((ShuttleApplication) context.getApplicationContext()).putUserSelectedArtwork(artworkProvider.getArtworkKey(),
                        ...
                        ((ShuttleApplication) context.getApplicationContext()).removeUserSelectedArtwork(artworkProvider.getArtworkKey());
                    }
                    dialog.dismiss();
                })
